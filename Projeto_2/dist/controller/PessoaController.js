...
let pessoaController = class pessoaController extends tsoa_1.Controller {
    ...
    ;
    atualizarPessoa(dto, fail, success) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const pessoa = yield this.PessoaService.atualizaPessoa(dto);
                return success(201, new BasicResponseDto_1.BasicResponseDto("Pessoa atualizada com sucesso!", pessoa));
            }
            catch (error) {
                return fail(400, new BasicResponseDto_1.BasicResponseDto(error.message, undefined));
            }
    ...
    ;
    deletarPessoa(dto, fail, success) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const pessoa = yield this.PessoaService.deletaPessoa(dto);
                return success(201, new BasicResponseDto_1.BasicResponseDto("Pessoa deletada com sucesso!", pessoa));
            }
            catch (error) {
                return fail(400, new BasicResponseDto_1.BasicResponseDto(error.message, undefined));
            }
    ...
    ;
    filtrarPessoa(id, fail, success) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const pessoa = yield this.PessoaService.filtraPessoa(id);
                return success(201, new BasicResponseDto_1.BasicResponseDto("Pessoa encontrada com sucesso!", pessoa));
            }
            catch (error) {
                return fail(400, new BasicResponseDto_1.BasicResponseDto(error.message, undefined));
            }
    ...
    ;
    listarPessoas(fail, success) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const pessoas = yield this.PessoaService.filtraPessoas();
                return success(201, new BasicResponseDto_1.BasicResponseDto("Pessoas listadas com sucesso!", pessoas));
            }
            catch (error) {
                return fail(400, new BasicResponseDto_1.BasicResponseDto(error.message, undefined));
            }
